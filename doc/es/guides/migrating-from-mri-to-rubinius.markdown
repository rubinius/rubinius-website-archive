...
probablemente necesitaras alternar entre MRI y Rubinius durante la migración,
...
implementaciones de Ruby. Todos los ejemplos de esta guía usaran `chruby`.
...
Refiérete a la documentación para encontrar más [instrucciones de configuración](https://github.com/postmodern/chruby#configuration).
...
herramientas de análisis y compilación de código Ruby, así como el 
...
Tu Gemfile debería funcionar bien con Rubinius pero deberías ejecutar 
...
hasta que completes la migración a Rubinius como se muestra a continuación:
    ...
    # Ejemplo de un bloque con gemas específicas a l plataforma MRI
    platforms :mri do
      gem 'ruby-prof'
      gem 'ruby-debug'
    end
...
versión 2.1 de MRI. Algunas características como los argumentos keyword, no han
sido implementados aún. Puede que otras características no hayan sido
